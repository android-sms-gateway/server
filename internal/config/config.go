...
type OpenAPI struct {
	...
	APIHost string `yaml:"api_host" envconfig:"HTTP__OPENAPI__API_HOST"` // public API host
	APIPath string `yaml:"api_path" envconfig:"HTTP__OPENAPI__API_PATH"` // public API path
}
